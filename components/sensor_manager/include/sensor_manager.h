...
#define OFFSET_SENSOR_RIGHT 40
#define OFFSET_SENSOR_CENTER 40
#define OFFSET_SENSOR_LEFT 70
 ...
 */
esp_err_t sensor_manager_init(SensorConfig_t *configs, int count, int sda_pin,
                              int scl_pin, uint32_t speed_hz,
                              SensorMode_t mode);
 ...
 */
void sensor_manager_read_all(SensorConfig_t *configs, int count,
